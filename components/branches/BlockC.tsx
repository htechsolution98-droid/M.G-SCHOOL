...
const blockData = {
  ...
  description:
    "Our premium dual-medium campus offering global learning standards and world-class sports and technology infrastructure.",
  image: "/images/school3 (1).jpg",
  location: "Central Hub, Education Square",
  principal: "Mr. Amit Khanna",
  specialties: [
    "Robotics & AI Lab",
    "Bilingual Academy",
    "Olympic Pool",
    ...
    >
      <div className="flex flex-col lg:flex-row gap-20 items-center">
        ...
        <div className="lg:w-1/2 relative">
          <div className="absolute top-0 left-0 w-24 h-24 bg-secondary -translate-x-12 -translate-y-12 rounded-[2rem] z-10 hidden xl:flex items-center justify-center text-primary">
