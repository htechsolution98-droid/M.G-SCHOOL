    ...
    <div className="absolute bottom-32 left-1/2 -translate-x-1/2 z-50 w-[90%] max-w-2xl">
      ...
      >
        ...
        <div
          ...
          style={{ background: `radial-gradient(ellipse at center, ${announcement.bgColor || "#F59E0B"} 0%, transparent 70%)` }}
        />
        ...
        >
          <Megaphone size={15} style={{ color: announcement.textColor || "#1E3A8A" }} />
        </div>
