...
export default function WhyChooseUsPage() {
  ...
  const slides = whyChooseUs.heroSlider && whyChooseUs.heroSlider.length > 0 ? whyChooseUs.heroSlider : [fallbackSlide];
    ...
    <div className="pb-24 min-h-screen bg-slate-50">
      {slides.length > 0 ? (
        <section className="relative h-screen w-full overflow-hidden mb-16">
          ...
          <button className="whychoose-prev absolute left-6 top-1/2 -translate-y-1/2 z-30 w-14 h-14 rounded-full bg-white/10 backdrop-blur-sm border border-white/20 flex items-center justify-center text-white hover:bg-white/30 transition-all cursor-pointer hidden md:flex">
            <ChevronLeft size={24} />
          </button>
          <button className="whychoose-next absolute right-6 top-1/2 -translate-y-1/2 z-30 w-14 h-14 rounded-full bg-white/10 backdrop-blur-sm border border-white/20 flex items-center justify-center text-white hover:bg-white/30 transition-all cursor-pointer hidden md:flex">
